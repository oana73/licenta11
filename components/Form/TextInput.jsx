    ...
    <div className={className}>
      ...
      <div className="mt-2 relative">
        <input
          ...
          autoComplete={name}
          className="block w-full rounded-md border-0 py-2 bg-transparent text-neutral-600 dark:text-neutral-200 shadow-sm ring-1 ring-inset ring-neutral-400 placeholder:text-neutral-400 focus:ring-0.5 focus:ring-inset focus:ring-cyan-500 sm:text-sm sm:leading-6 pr-10"
