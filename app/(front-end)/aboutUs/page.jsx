  ...
  return (
    ...
    <div className='mx-auto max-w-screen-2xl text-white dark:text-neutral-900'>
      <div className="absolute top-1/2 transform -translate-y-1/2 w-1/2 text-justify ">
        ...
        <span className='break-all text-xs md:text-sm lg:text-2xl font-medium '>Here creativity knows no bounds! Discover a treasure trove of handcrafted wonders, each piece telling a unique story. Whether you're a buyer seeking one-of-a-kind treasures or an artist looking to sell your art, join our community and indulge in the magic of handmade craftsmanship.</span>
