    ...
    <section className="py-12 sm:py-16 lg:py-20">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-5xl">
        <div className="max-w-2xl mx-auto">
          <div className="relative mt-6 overflow-hidden bg-neutral-50 dark:bg-neutral-700 rounded-lg shadow md:mt-10">
            <div className="absolute top-4 right-4">
              <Link
                href={`/dashboard/orders/${order.id}/invoice`}
                className="inline-flex items-center justify-center px-4 py-3 text-xs font-bold text-neutral-900 transition-all duration-200 bg-neutral-100 border border-transparent rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-500 hover:bg-neutral-200"
              >
                View invoice
              </Link>
            </div>
            ...
            <div className="px-4 py-6 sm:px-8 sm:py-10">
              <div className="-my-8 divide-y divide-neutral-200">
                <div className="pt-16 pb-8 text-center sm:py-8 ">
                  <CheckCircle2 className="w-10 h-10 mx-auto text-green-700" />

                  <h1 className="mt-4 text-2xl font-bold text-neutral-900 dark:text-neutral-50">
                    We received your order!
                  </h1>
                  <p className="mt-2 text-sm font-normal text-neutral-600 dark:text-neutral-300">
                ...
                <div className="py-8">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-8 sm:gap-x-20">
                    <div>
                      <h2 className="text-xs font-bold tracking-widest text-neutral-400 uppercase dark:text-neutral-500">
                        Shipping Address
                      </h2>
                ...
                <div className="py-8">
                  ...
                  <div className="flow-root mt-8">
                    <ul className="divide-y divide-neutral-200 -my-7">
                      {orderItems.length > 0 &&
                            ...
                            >
                              <div className="flex items-stretch">
                                ...
                                <div className="flex flex-col justify-between ml-5 w-44">
                                  <p className="flex-1 text-sm font-bold text-neutral-900 dark:text-neutral-300">
                                    {item.title}
                                  </p>
                                </div>
                              </div>
                              ...
                              <div className="ml-auto">
                                <p className="text-sm font-bold text-right text-neutral-900 dark:text-neutral-300">
                                  ${item.price}
                                </p>
                              </div>
                            </li>
